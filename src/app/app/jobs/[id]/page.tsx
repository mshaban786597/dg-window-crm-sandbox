  ...
  if (!job) {
    return (
      <div className="text-center py-20">
        <p>Job not found.</p>
        <Button variant="link" asChild><Link href="/app/jobs">Back</Link></Button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <>
            <Button variant="outline" asChild><Link href="/app/jobs"><ArrowLeft className="h-4 w-4 mr-1" /> Back</Link></Button>
